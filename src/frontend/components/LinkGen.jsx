...
function historyObj(data){
  return <div style={styles_History.container}>
    <div style={styles_History.content}>
      ...
      <a style={styles_History.info} target="_blank" href={data.originalURL} >{data.originalURL}</a>
    </div>
    <div style={styles_History.content}>
      <div style={styles_History.key}>Богино холбоос:</div>
      <div style={styles_History.copyContainer}>
        <a style={styles_History.info} target="_blank" href={`${window.location.href}${data._id}`}>{window.location.href}{data._id}</a>
